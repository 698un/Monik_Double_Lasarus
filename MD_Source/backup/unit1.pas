...
if form2.img1.left<>0 then form2.img1.Left:=0;
if form2.img1.Width<>form2.ClientWidth then form2.img1.Width:=form2.ClientWidth;


if check_prop.checked=false then h1:=form2.ClientHeight;


if check_prop.checked=true then h1:=trunc(form2.img1.width/c);


if form2.img1.height<>h1 then form2.img1.Height:=h1;

form2.img1.Top:=trunc(form2.ClientHeight/2-h1/2);
